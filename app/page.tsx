...
export default function Component() {
  ...
  // ADICIONADO: Meta Pixel initialization - LINHAS 77-95
  useEffect(() => {
    // Inicializar Meta Pixel quando o componente montar
    if (typeof window !== "undefined" && window.fbq) {
      // Se o fbq já existe, apenas track PageView
      window.fbq("track", "PageView")
    }
  }, [])

  // ADICIONADO: Função para rastrear eventos do Meta Pixel - LINHAS 97-108
  const trackMetaPixelEvent = useCallback((eventName: string, parameters?: any) => {
    if (typeof window !== "undefined" && window.fbq) {
      if (parameters) {
  ...
  const scrollToProdutos = useCallback(() => {
    ...
    // ADICIONADO: Rastrear clique no botão "Explorar produtos" - LINHA 114
    trackMetaPixelEvent("Lead", { content_name: "Explorar Produtos Button" })
  }, [trackMetaPixelEvent])
  ...
  const openProductModal = useCallback(
    (product: any) => {
      ...
      // ADICIONADO: Rastrear visualização de produto - LINHAS 130-135
      trackMetaPixelEvent("ViewContent", {
        content_name: product.name,
        content_category: "Product",
        value: Number.parseFloat(product.price.replace("R$ ", "").replace(",", ".")),
        currency: "BRL",
      })
    },
    [trackMetaPixelEvent],
  ...
  const openFormModal = useCallback(() => {
    ...
    // ADICIONADO: Rastrear início do checkout - LINHAS 155-161
    if (selectedProduct) {
      trackMetaPixelEvent("InitiateCheckout", {
        content_name: selectedProduct.name,
        value: Number.parseFloat(selectedProduct.price.replace("R$ ", "").replace(",", ".")),
        currency: "BRL",
      })
    }
  }, [selectedProduct, trackMetaPixelEvent])
      ...
      try {
        ...
        if (result.success) {
          ...
          if (result.is_approved) {
            ...
            // ADICIONADO: Rastrear compra aprovada - LINHAS 207-214
            if (selectedProduct) {
  ...
  const handleRealizarPedido = useCallback(async () => {
    ...
    try {
      ...
      if (pixResult.success && pixResult.payment_id) {
        ...
        // ADICIONADO: Rastrear geração do PIX - LINHAS 360-366
  ...
  }, [selectedProduct, orderData, closeFormModal, startPolling, sendEmailNotification, trackMetaPixelEvent])
  ...
  const products = useMemo(
    () => [
      {
        id: 1,
        name: "Pepper Blend Sedenta Por Oral",
        price: "R$ 33,80",
        rating: 4.9,
        reviews: 527,
        image: "/sedenta.jpg?height=300&width=400",
        description:
          "Gel lubrificante íntimo. Pepper Blend Sedenta Por Oral Sem Açúcar Lollipop é ideal para saciar a sede de quem deseja sensações a flor da pele com mais intensidade.",
        features: [
          "Altamente deslizante",
          "Comestível sabor Lollipop",
          "Vibrante",
      ...
      },
      {
        ...
        features: [
          ...
          "Estimulação intensa do clitóris",
        ],
      },
      {
        id: 3,
        ...
        features: [
          "Comestível",
          "Ótimo para o sexo oral",
          "Levemente adocicado",
          "Região de aplicação: todas",
        ],
      },
    ],
    [],
  ...
  return (
    <>
      {/* ADICIONADO: Meta Pixel Script - LINHAS 447-465 */}
      <Script
        id="meta-pixel"
        ...
        dangerouslySetInnerHTML={{
          __html: `
            ...
            fbq('init', '4020037531644488');
            fbq('track', 'PageView');
          `,
        }}
      />

      {/* ADICIONADO: Noscript fallback para Meta Pixel - LINHAS 467-472 */}
      <noscript>
        <img
          height="1"
          width="1"
          style={{ display: "none" }}
          src="https://www.facebook.com/tr?id=4020037531644488&ev=PageView&noscript=1"
          alt=""
        />
      </noscript>
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <section
          ref={produtosRef}
          className="py-16 md:py-20 bg-gradient-to-b from-black via-red-950/5 to-black relative"
        >
          <div className="absolute inset-0 bg-gradient-to-l from-black via-red-950/10 to-black"></div>
          <div className="container mx-auto px-3 md:px-4 max-w-6xl relative z-10">
            <h2 className="text-xl md:text-4xl font-bold text-center text-red-500 mb-6 md:mb-12 drop-shadow-lg">
              ...
              <Card className="bg-gray-900 border-gray-800">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-lg text-gray-300 mb-6 italic">
                    "Serviço impecável! Qualidade excepcional, entrega rápida e atendimento personalizado. A SEDUZ
                    superou todas as minhas expectativas. Recomendo sem hesitar!"
                  </p>
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                ...
                <Button
                  ...
                  onClick={() => trackMetaPixelEvent("Subscribe", { content_name: "Newsletter" })}
                >
                  Inscrever
                </Button>
              </div>
...
// ADICIONADO: Declaração de tipos para o Meta Pixel - LINHAS 1180-1190
declare global {
  interface Window {
